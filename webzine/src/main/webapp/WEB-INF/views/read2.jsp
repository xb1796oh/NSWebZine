                                			...
                                			<div class="text" >
                                				...
                                				<div class="panel single-accordion">
                                					...
                                					<c:if test="${comment.replyCount > 0 }">
                                						<h7><a role="button" class="" aria-expanded="" aria-controls="collapseTwo${status.count}" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo${status.count}" >&nbsp;&nbsp;&nbsp;&nbsp;답글 ${comment.replyCount }개 보기&nbsp;&nbsp;&nbsp;&nbsp;
                                                     		<span class="accor-open"><i class="fa fa-plus" aria-hidden="true"></i></span>
                                                     		<span class="accor-close"><i class="fa fa-minus" aria-hidden="true"></i></span>
                                                      		</a></h7>
	...
	function writeComment(fbNo, id){
		...
		$.ajax({
			...
			success:function(data){
				...
				newComment += 		'<a role="button" class="" aria-expanded="true" aria-controls="comment-div' + comment.commentNo + 'n"  data-toggle="collapse" data-parent="#comment' + comment.commentNo + 'n"  href="#comment-div' + comment.commentNo + 'n">답글</a>';
				newComment += 	'</div>';
    ...
    function replyWrite(fbNo, commentNo, replySection, depth){
    	...
    	$.ajax({
    		...
    		success:function(data){
				...
				appendLists += 					'<a role="button" class="" aria-expanded="true" aria-controls="reply2-div' + reply.commentNo + '" data-toggle="collapse" data-parent="#reply2' + reply.commentNo + '" href="#reply2-div' + reply.commentNo + '">답글7</a>';
				appendLists += 				'</div>'
				appendLists += 			'</div>';
    		...
    		$.ajax({
        		...
        		success:function(data){
        			...
        			for(var i=0; i<replies.length; i++){
        				...
        				appendLists += 					'<a role="button" class="" aria-expanded="true" aria-controls="reply2-div' + replies[i].commentNo + '" data-toggle="collapse" data-parent="#reply2' + replies[i].commentNo + '" href="#reply2-div' + replies[i].commentNo + '">답글7</a>';
        				appendLists += 				'</div>'
        				appendLists += 			'</div>';
        				appendLists += 			'<div class="panel single-accordion">';
